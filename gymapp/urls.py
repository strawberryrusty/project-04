...
from .views import ProgrammeListView, ProgrammeDetailView, CategoryListView, CategoryDetailView, ProgrammeItemListView, ProgrammeItemDetailView, ExerciseListView, ExerciseDetailView
