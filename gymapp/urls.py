...
from .views import ProgrammeListView, ProgrammeDetailView, CategoryListView, CategoryDetailView, ProgrammeItemListView, ProgrammeItemDetailView, ExerciseListView, ExerciseDetailView, ItemListView, ItemDetailView, ItemPersonalBestListlView
...
urlpatterns = [
    ...
    path('items/<int:pk>/personalbests', ItemPersonalBestListlView.as_view(), name='items-personalbests'),
